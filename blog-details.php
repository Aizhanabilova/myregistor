...
<body data-baseurl = "<?=$BASE_URL?>" data-blogid=<?=$blog['id']?> data-authorid=<?=$_SESSION['id']?> data-blogauthor=<?=$blog['author_id']?>>
	...
	<div class="page-content">
		...
		?>
            <span class="comment-add">
                <textarea id="textarea" class="comment-textarea" placeholder="Введитe текст комментария"></textarea>
